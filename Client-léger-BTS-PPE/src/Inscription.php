...
<h1> Formulaire d'inscription </h1> <hr>
    <form action="Inscription.php" method="post">
        ...
        <input type="text"name="mdp" placeholder="Entrez votre mot de passe"><br><br>
        ...
        <input type="submit" value="Evoyer"name="bout"><br><br><hr>
...
$requete = "INSERT INTO clients(nomC,prenomC, loginC, mdpC) 
values ('$nomC','$prenomC','$loginC','$mdpC')";
